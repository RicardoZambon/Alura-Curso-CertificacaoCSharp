...
namespace Zambon.Alura.CertificacaoCSharp.Collections.Lists
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cronologia.InsertRange(1, novosFilmes);
            Imprimir(cronologia);
            ...
            Console.WriteLine(cronologia.FirstOrDefault());

            //TAREFA: exibir último filme da cronologia
            Console.WriteLine(cronologia.LastOrDefault());
