...
using Zambon.Alura.CertificacaoCSharp.Cinema.Dados;
using Zambon.Alura.CertificacaoCSharp.Cinema.Performance;

namespace Zambon.Alura.CertificacaoCSharp.Cinema
{
    class Program
    {
